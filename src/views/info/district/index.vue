...
const permission = "District";
const routeName = "District";
...
<template>
  <ui-parent-card>
    <form-table :fields="fields" :permission="permission" :router-name="routeName" :service="DistrictService" append-action :filter="filter">
